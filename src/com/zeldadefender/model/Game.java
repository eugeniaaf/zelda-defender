...
public class Game
{
    ...
    public Game(int[][] map)
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            Enemy topEnemy = new Enemy(quickLoad("enemy"), tileGrid.getTile(i, topY), tileGrid, Constant.TILE_WIDTH, Constant.TILE_HEIGHT, 5);
            topEnemies.add(topEnemy);
            Enemy botEnemy = new Enemy(quickLoad("enemy"), tileGrid.getTile(i, botY), tileGrid, Constant.TILE_WIDTH, Constant.TILE_HEIGHT, 5);
            botEnemies.add(botEnemy);

            switch (i)
            {
                case 0:
                    towers.add(new Tower(quickLoad("tower"), tileGrid.getTile(20, 3), 48, 32, 10));
                    break;
                case 1:
                    towers.add(new Tower(quickLoad("tower"), tileGrid.getTile(20, 25), 48, 32, 10));
                    break;
                case 2:
                    towers.add(new Tower(quickLoad("tower"), tileGrid.getTile(40, 14), 48, 32, 10));
                    break;
            }
        }
